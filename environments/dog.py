...
class DogEnvironment(GridWorld):
    name = "dog"
    ...
    def step(self, action):
        ...
        new_dog_loc = np.clip(self._dog_loc + self._dog_dir, 0, self.size - 1)
        if not self.intersects_wall(new_dog_loc):
